...
class PersonTest {
    ...
    val person2 = Person("e079e175c75a44f180e98789").update(DateTime.parse("2018-06-25T14:09:07.815+07:00")) {
        identities.add(ThaiCitizenId("1122233212343"))
        orgId = "32409198236497321949"
        prename = "นาย"
        firstname = "สมหมาย"
        lastname = "พารวย"
        birthDate = LocalDate.parse("1874-12-12")
        avatarUrl = "https://avatars3.githubusercontent.com/u/783403?s=460&v=4"
        link = Link(
            System.JHICS, "pid" to "1234567", "cid" to "1122233212343",
            lastSync = DateTime.parse("2018-06-25T14:09:07.815+07:00")
        )
    }
    ...
    @Test
    fun relation() {
        person.addRelationship(Person.Relate.Child to person2)
        person2.addRelationship(Person.Relate.Father to person)

        person.childId.size `should equal` 1
        person.childId.first() `should be equal to` "e079e175c75a44f180e98789"
        person2.fatherId!! `should be equal to` "e079e175c75a44f180e8eaeb"

        person.motherId `should equal` null
    }
